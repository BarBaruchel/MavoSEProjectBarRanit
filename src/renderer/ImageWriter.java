...
public class ImageWriter {
     ...
     *
     * @param imageName the name of jpeg file   (the name of the image)
    ...
    public ImageWriter(String imageName, int nX, int nY) {
        ...
        //creating BufferedImage in size nX multiply nY, it`s kind that can contain RGB type
    ...
    public void writeToImage() {
        try {
            //creating a file in the FOLDER_PATH place that mean creating in images directory + the add the we gave "imageName" + and add ".png" ending
            File file = new File(FOLDER_PATH + '/' + imageName + ".png");
            file.mkdirs();
            //create an image of "png" type , with the file
